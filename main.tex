...
Cette synthèse a été écrite par plusieurs étudiants  d'informatique et les auteurs ne garantissent
pas l'absence de petites erreurs ou la complétude par rapport au cours. Elle est 
plutôt destinée à être un recueil d'informations que de raisonnements.\\

La source .tex de cette synthèse est sur \url{https://github.com/fhennecker/elec-synthese}.
...
\section{Vademecum d'électricité (chapitre 2)}
    ...
    \subsection{Composants réactifs}
        ...
        \subsubsection{Circuit RC en temporel}
            ...
            \begin{figure}[H]
                \begin{center}
                    \includegraphics[width=0.4\textwidth]{fig/2_rc_temp.png}
